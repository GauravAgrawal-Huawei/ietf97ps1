...
import static org.onosproject.yangutils.datamodel.YangNodeType.DEVIATION_NODE;
import static org.onosproject.yangutils.datamodel.utils.DataModelUtils.addResolutionInfo;
import static org.onosproject.yangutils.datamodel.utils.YangConstructType.DESCRIPTION_DATA;
import static org.onosproject.yangutils.datamodel.utils.YangConstructType.DEVIATE_NOT_SUPPORTED;
...
public final class DeviationListener {
    ...
    public static void processDeviationEntry(TreeWalkListener listener,
        ...
        String deviationArg = ctx.deviation().getText();
    ...
    private static void validateSubStatementsCardinality(GeneratedYangParser
        ...
        validateCardinalityMaxOne(ctx.deviateNotSupportedStatement(), DEVIATE_NOT_SUPPORTED,
                                  DEVIATION_DATA, ctx.deviation().getText());
        /*
         * TODO : either deviate not supported or deviate add/replace/delete
         * can come
         */
    }
